import { DefinitionNode, FunctionCallNode } from '../../core/ast/ast';
import { findFunctionAtOffset, findAttributeAtOffset, findStatementAtOffset } from '../../core/ast/astQuery';
