...
import { LexerState, LexicalDiagnostic } from "./lexer/LexerState";
import { TriviaScanner } from "./lexer/TriviaScanner";
import { TokenScanner } from "./lexer/TokenScanner";

export { LexicalDiagnostic } from "./lexer/LexerState";
