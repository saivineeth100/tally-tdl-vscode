# Sub Category Allocations Schema

> **Version**: 7.0

Reference documentation for the **Sub Category Allocations** schema.
...
| **Duty Ledger** | No | No | String (Master Reference) |
| **Excisecreditamount** | No | No | Amount |
| **Exciseunitname** | No | No | String (Master Reference) |
| **Inputcredit** | No | No | Amount |
| **Oldassessableamount** | No | No | Amount |
| **Oldtaxrate** | No | No | Number |
| **Origassessableamount** | No | No | Amount |
| **Origtaxamount** | No | No | Amount |
| **Origtaxdate** | No | No | Date |
| **Paidamount** | No | No | Amount |
| **Realised Assessable Amount** | No | No | Amount |
| **Returnedqty** | No | No | Quantity |
